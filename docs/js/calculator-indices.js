...
import { findLatestIndicesFile } from './indices.js';
...
export const indicesState = {
    ...
    rajaneliohinta: null,
    indicesLoaded: false,
    indicesData: null // Store raw JSON data for charts
};

// Export individual properties for convenience (they reference the state object)
export const rakennuskustannusindeksi = indicesState.rakennuskustannusindeksi;
export const markkinahintaindeksi = indicesState.markkinahintaindeksi;
export const vanhatMarkkinahintaindeksi = indicesState.vanhatMarkkinahintaindeksi;
export const rajaneliohinta = indicesState.rajaneliohinta;
export const indicesLoaded = indicesState.indicesLoaded;
export const indicesData = indicesState.indicesData;
...
export async function loadIndices() {
    try {
        ...
        indicesState.rakennuskustannusindeksi = parseIndexData(data.rakennuskustannusindeksi, 'rakennuskustannusindeksi');
        indicesState.markkinahintaindeksi = parseIndexData(data.markkinahintaindeksi, 'markkinahintaindeksi');
        
        // Parse optional indices
        if (data.vanhat_markkinahintaindeksi) {
            indicesState.vanhatMarkkinahintaindeksi = parseIndexData(data.vanhat_markkinahintaindeksi, 'vanhat_markkinahintaindeksi');
        } else {
